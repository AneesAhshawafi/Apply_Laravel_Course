 ...
 <!-- general form elements -->
            <div class="card card-primary" style="width: 80%;">
              <div class="card-header">
                <h3 class="card-title" style="float: right;"  >تعديل كورس</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->           
                <form action="{{route('courses.update',$course->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{old('name',$course->name)}}" id="exampleInputEmail1" placeholder="ادخل اسم الكورس">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="active" id="exampleInputPassword1">
                            ...
                            <option value="1" {{ old('active', $course->active) == 1 ? 'selected' : '' }}>فعال</option>
                            <option value="0" {{ old('active', $course->active) == 0 ? 'selected' : '' }}>معطل</option>
                        </select>
                        @error('active')
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
