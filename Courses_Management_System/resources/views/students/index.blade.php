...
@section('content')
    ...
    <br>
    {{-- Calling components --}}
    {{-- <x-alert alert-type="error" :message="$students[0]->name" />
    <x-alert alert-type="error" :message="$students[0]->name" /> --}}
    {{-- Short Attribute Syntax --}}
    {{-- {{ $message = $students[0]->name }}
    <x-alert alert-type="error" :$message /> --}}
    {{-- <x-forms.input /> --}}
    <div class="col-12">
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 " style="width: 200px;margin-right:20 px;margin-left:20px">
                        <label style="margin-right:10px;margin-left:10px;"
                            for="searchByActivationStatus">{{ __('students/index.search.search_by_activaion_status') }}</label>
                        <select id="searchByActivationStatus" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($student->active)
                                                <span class="badge badge-active">
                                                    <span class=""></span>
                                                    {{ __('students/index.status.active') }}
                                                </span>
                                            @else
                                                <span class="badge badge-inactive">
                                                    <span class=""></span>
                                                    {{ __('students/index.status.inactive') }}
                                                </span>
                                            @endif
                                        </td>
                                        <td>{{ $student->phone }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('students.edit', $student->id) }}"
                                                ...
                                                title="{{ __('students/index.actions.edit') }}">
                                            ...
                                            <a href="{{ route('students.delete', $student->id) }}"
                                                ...
                                                title="{{ __('students/index.actions.move_to_trash') }}">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                            <a href="{{ route('students.show', $student->id) }}"
                                                class="btn btn-sm btn-warning" style="margin: 5px;"
                                                title="{{ __('students/index.actions.view_details') }}">
